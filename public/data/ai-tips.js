...
window.WB_AI_TIPS = {
  ...
  items: [
    {
      source: 'auto',
      id: 'ai-auto-20260817-1',
      title: '我用 WorkBuddy 管 4 个自媒体账号：一个 AI 运营搭档的实操记录',
      platform: 'qcloud',
      author: '腾讯云开发者社区',
      duration: '图文约 8 分钟',
      views: '多账号运营实操帖',
      date: '2026-08',
      tags: ['WorkBuddy', '多账号', '自动化任务', '质控会话', '省积分'],
      summary: '一个人跑抖音／视频号／公众号／私域四个号的真实打法：① 把账号调性、红线、格式写成一份「生成规范.md」，让定时任务照着出脚本；② 单独开一个「质控会话」每天巡检四个空间，防内容撞车、防导流断链；③ 每个自动化提示词里都写「不冗余联网、直接落盘、精简输出」省额度。',
      takeaway: '诚悦品牌部三个人管订阅号＋服务号＋视频号，最该抄的是"生成规范.md"——把禁用词、六大产品体系、CYT STORY 标题格式写死一次，AI 就不会跑偏。',
      url: 'https://cloud.tencent.com/developer/article/2723206',
      badge: '新推送'
    },
    {
      source: 'auto',
      id: 'ai-auto-20260817-2',
      title: 'WorkBuddy Skill 实战：3 个坑、1 个案例、4 个技巧，我把效率提升了 12 倍',
      platform: 'qcloud',
      author: '小剑喵 · 腾讯云开发者社区',
      duration: '图文约 8 分钟',
      views: 'Skill 实战爆款帖',
      date: '2026-07',
      tags: ['WorkBuddy', 'Skill', 'COMPLIANCE.md', '素材库', '公众号运营'],
      summary: '完整拆解一个公众号运营 Skill 怎么搭：SKILL.md 只放执行流程（控制在 30–40KB，写太大反而爆上下文）、COMPLIANCE.md 单独放敏感词替换表、bank/ 存标题库金句库案例库。三个坑：文件写太大、建完不维护、分不清 Skill（怎么做）与 Expert（谁来做）。作者实测选题到发布从 3 小时压到 10 分钟。',
      takeaway: '照这套给诚悦建一个"CYT STORY 推文 Skill"：绝对化用语替换表进 COMPLIANCE.md，历史爆款标题进 bank/，写一篇省下的时间比建它的时间多得多。',
      url: 'https://developer.cloud.tencent.com/article/2703186?policyId=1004',
      badge: '热门'
    },
    {
      source: 'auto',
      id: 'ai-auto-20260817-3',
      title: 'WorkBuddy 自动化实战：3 个场景让每日重复工作"自动跑起来"（附 5 个常见坑）',
      platform: 'qcloud',
      author: '腾讯云开发者社区',
      duration: '图文约 10 分钟',
      views: '自动化避坑长文',
      date: '2026-08',
      tags: ['WorkBuddy', '自动化任务', '定时任务', 'Prompt 自包含', '省积分'],
      summary: '三条铁律：① Prompt 必须自包含——自动化每次都是全新会话，不能依赖历史对话；② 输出要可追溯——明确写"保存到当前工作目录"并指定文件名格式；③ 从简单场景开始跑通再扩展。五个高频坑：任务不触发（检查客户端后台运行＋状态是否 ACTIVE）、上下文丢失、输出文件找不到、积分消耗过快、工作目录未创建。',
      takeaway: '工作台"每周内容抓取"就是这套逻辑——想再加一个"每周五自动汇总视频号数据"，记得把口径和文件名写进提示词，别指望它记得上周聊过什么。',
      url: 'https://cloud.tencent.com/developer/article/2721636'
    },
    {
      source: 'auto',
      id: 'ai-auto-20260817-4',
      title: '15 条高频实用的 Claude Code 技巧，帮你快速上手',
      platform: 'bilibili',
      author: 'B站 AI 编程 UP',
      duration: '约 15 分钟',
      views: '技巧清单向热门',
      date: '2026-08',
      tags: ['Claude Code', '15 条技巧', '计划模式', '上下文管理', 'Skill'],
      summary: '十五条可当清单用的实操技巧：设 cc 别名、用 /init 重构 CLAUDE.md、Esc+Esc 直接进 /rewind 回滚、不确定怎么做就用计划模式、别用自己的话转述 bug 直接贴报错、无关任务先 /clear 清空上下文、尽可能多创造技能、用子代理保持主上下文清晰、告诉它具体看哪些文件。',
      takeaway: '"别转述、直接贴原文"这条同样适用于品牌部——让 AI 改稿时把领导原话原封不动贴进去，比自己复述一遍准得多。',
      url: 'https://www.bilibili.com/video/BV1TuQmBVEdB/',
      badge: '推荐'
    },
    {
      source: 'auto',
      id: 'ai-auto-20260817-5',
      title: '小白的 Coze 之旅 1.0：零基础从零搭建第一个 AI 智能体',
      platform: 'bilibili',
      author: '通往 AGI 之路 · 元子',
      duration: '共学课回放',
      views: '零基础智能体入门课',
      date: '2026',
      tags: ['Coze', '扣子', '智能体', '零基础', '多维表格'],
      summary: '面向完全不懂技术的人：从注册开始，一步步搭出第一个能对话、能查资料的智能体，同系列还有「Coze 发布多维表格实战」。配套飞书文字讲义可对照操作，不用写一行代码。',
      takeaway: '品牌部可以拿它搭一个"选题打分机器人"——把 7 维度加权评分规则填进去，扔一个选题进去直接出分，省掉手工算分那一步。',
      url: 'https://www.bilibili.com/video/BV1wxBCY8ESs/'
    },
    {
      source: 'auto',
